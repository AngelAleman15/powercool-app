...
export default function AuthPage() {
  ...
  return <div className="min-h-screen w-full overflow-x-hidden bg-[radial-gradient(circle_at_1px_1px,#d8e4f4_1px,transparent_1px)] bg-[size:16px_16px] md:ml-[-280px] md:w-[calc(100%+280px)] lg:h-screen lg:overflow-hidden lg:grid lg:grid-cols-[minmax(420px,37%)_1fr]">
