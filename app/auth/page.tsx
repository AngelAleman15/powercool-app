...
export default function AuthPage() {
  ...
  return <div className="min-h-screen w-full bg-[radial-gradient(circle_at_1px_1px,#d8e4f4_1px,transparent_1px)] bg-[size:16px_16px] md:ml-[-280px] md:w-[calc(100%+280px)] lg:grid lg:grid-cols-[minmax(420px,37%)_1fr]">
    <aside className="relative hidden min-h-screen overflow-hidden bg-[#061426] p-14 text-white lg:flex lg:flex-col" style={{ backgroundImage: "linear-gradient(180deg,rgba(3,16,32,.54),rgba(4,24,49,.28),rgba(3,17,34,.72)),url('/sidebar-mountains.png')", backgroundPosition: "center", backgroundSize: "cover" }}>
